...
// EXPLAIN => After this line we tell the props type by type aliases also we can explicitly tell the functional components return type what it will be returning from him.
